...
void Main()
{
	...
	sb.Append("| ---- |")
		...
		.AppendLine("|");
	//var benchmarks = new[] { "Index", "Add", "Insert", "CreateRange", "AddRange", "SetItem", "BuilderSetItem" };
	//var benchmarks = new[] { "RemoveAt", "RemoveRange", "IndexOf", "CopyTo" };
	var benchmarks = new[] { "Enumeration" };
