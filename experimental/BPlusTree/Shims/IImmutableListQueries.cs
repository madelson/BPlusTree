...
namespace System.Collections.Immutable
{
    ...
    internal interface IImmutableListQueries<T> : IReadOnlyList<T>
    {
        ...
        /// </returns>
        ArrayBasedBPlusTreeImmutableList<TOutput> ConvertAll<TOutput>(Func<T, TOutput> converter);
        ...
        /// </returns>
        ArrayBasedBPlusTreeImmutableList<T> GetRange(int index, int count);
        ...
        /// </returns>
        ArrayBasedBPlusTreeImmutableList<T> FindAll(Predicate<T> match);
